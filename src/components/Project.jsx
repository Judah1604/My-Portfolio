...
const Project = ({ heading, details, tools, filename, isPortfolio, url }) => {
    ...
    return (
        <div className="project row">
            <motion.div className="project-text col-md-5" initial={{ translateX: -500 }} whileInView={{ translateX: 0 }}>
                <h2>{heading}</h2>
                <p>{details}</p>
                <ul className="tools">
            ...
            <motion.div className="project-img col-md-5" initial={{ translateX: 500 }} whileInView={{ translateX: 0 }} transition={{ type: 'spring', bounce: 0.4 }}>
